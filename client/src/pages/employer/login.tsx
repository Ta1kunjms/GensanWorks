        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {authSettings.providers.find(p => p.id === 'google' && p.enabled) && (
              <a href="/auth/google?role=employer&prompt=select_account" className="mt-3 w-full inline-flex items-center justify-center gap-2 bg-white border border-slate-300 hover:border-green-600 text-slate-900 py-2 rounded-lg transition shadow-sm hover:shadow">
