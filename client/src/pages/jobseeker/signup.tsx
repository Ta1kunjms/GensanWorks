      ...
      <div className="w-full max-w-lg">
        <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join as a Jobseeker</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 mb-6">
            <div className="flex items-start space-x-3 mb-2">
              ...
              <p className="text-sm text-gray-700">Access thousands of job opportunities</p>
            </div>
            <div className="flex items-start space-x-3 mb-2">
              <CheckCircle className="h-5 w-5 text-purple-600 flex-shrink-0 mt-0.5" />
              <p className="text-sm text-gray-700">Get matched with employers instantly</p>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-purple-600 flex-shrink-0 mt-0.5" />
              <p className="text-sm text-gray-700">Track your applications in real-time</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition transform hover:scale-[1.02] active:scale-[0.98] shadow-lg"
            >
          ...
          <div className="mt-6 space-y-3">
            <p className="text-sm text-gray-600 text-center">
              ...
              <Link href="/jobseeker/login" className="text-purple-600 hover:text-purple-700 font-semibold">
                Sign in
              </Link>
            </p>
